...
/**
 * Utility to parse Market Cap numbers into billions.
 * Formerly in data-fetcher.js, integrated here for completeness.
 */
function parseMarketCap(marketCapNum) {
  if (marketCapNum === null || marketCapNum === undefined) return 0;
  const number = parseFloat(marketCapNum) || 0;
...
class FinancialDataManager {
  ...
  formatMarketCap(value) {
    ...
    // Since parseMarketCap now converts to billions, always display in billions
